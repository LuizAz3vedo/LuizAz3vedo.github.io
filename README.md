<p align="center">
  <img src="/assets/me.png" alt="Luiz Antônio Azevedo" class="profile-picture"> <h1 align="center">Luiz Antônio Azevedo</h1>
...
<section id="-formação--qualificações">
...
<section id="-experiência-profissional">
...
**Resumo:** Transformando dados hospitalares em insights estratégicos.
...
**Resumo:** Business Intelligence & Relatórios Gerenciais.
...
**Resumo:** Mentoria em Lógica de Programação para Jovens Talentos.
...
**Resumo:** Projeto de Crypto & ETL End-to-End.
...
<section id="-pesquisa--colaborações">
...
<section id="-portfólio-de-projetos">
## 🚀 Portfólio de Projetos

### ♟️ Análise de Dados de Xadrez
**Descobrindo padrões de performance em mais de 20.000 partidas do Lichess.**
...
- **Imagens:**
  <div class="project-images-container">
    <div class="portfolio-images">
      <img src="https://github.com/LuizAz3vedo/Portf-lio/assets/99042862/e4c26e35-13c4-4541-a8f4-bd9f6d078937" alt="Chess 1" />
    </div>
    <div class="portfolio-images">
      <img src="https://github.com/LuizAz3vedo/Portf-lio/assets/99042862/0183f766-f8c1-424c-b7d5-3c9ae1e70e31" alt="Chess 2" />
    </div>
    <div class="portfolio-images">
      <img src="https://github.com/LuizAz3vedo/Portf-lio/assets/99042862/a49472a6-ddfb-4a50-b77b-35eeb7f1179f" alt="Chess 3" />
    </div>
  </div>
...
**Segmentação inteligente de clientes com K-means integrada a dashboards Power BI.**
...
- **Imagens:**
  <div class="project-images-container">
    <div class="portfolio-images">
      <img src="https://github.com/user-attachments/assets/7aa0b3d9-cad5-4090-99de-77ff7c970951" alt="BI + K-means">
    </div>
  </div>
...
**Construindo uma arquitetura de dados robusta e escalável (Bronze, Silver, Gold).**
...
- **Imagens:**
  <div class="project-images-container">
    <div class="portfolio-images">
      <img src="assets/Medalion.png" alt="Data Warehouse" /> </div>
  </div>

---

### 💰 Painel de Análise de Cashback
**Otimizando estratégias de cashback através da análise de ROI e volume de vendas.**
...
- **Imagens:**
  <div class="project-images-container">
    <div class="portfolio-images">
      <img src="assets/BI2.png" alt="Análise de Performance de Grupos com Cashback"> </div>
  </div>

---

### 🚀 Big Data com DuckDB
**Processamento eficiente de 1 bilhão de registros meteorológicos sem carregamento total em memória.**
...
- **Imagens:**
  <div class="project-images-container">
    <div class="portfolio-images">
      <img src="assets/1b.png" alt="Big Data" /> </div>
  </div>

---

### 🤖 Estudos em Inteligência Artificial
**Implementação prática de algoritmos de Machine Learning & Deep Learning.**
...
- **Imagens:**
  <div class="project-images-container">
    <div class="portfolio-images">
      <img src="assets/IA.png" alt="AI Study" /> </div>
  </div>

---

### 📊 NLP – Análise de Tweets sobre Desastres
**Classificando tweets sobre desastres com técnicas avançadas de NLP e Machine Learning.**
...
- **Imagens:**
  <div class="project-images-container">
    <div class="portfolio-images">
      <img src="assets/nple.png" alt="NLP Analysis" /> </div>
  </div>

---

### 📈 Análise de Criptomoedas (Bitcoin)
**Análise temporal avançada do Bitcoin (BTC/USD) usando séries temporais, clustering e detecção de anomalias.**
...
- **Imagens:**
  <div class="project-images-container">
    <div class="portfolio-images">
      <img src="assets/btc.png" alt="Crypto Analysis" /> </div>
  </div>

---

### 🧠 Algoritmos e Estruturas de Dados
**Implementações didáticas de algoritmos fundamentais e estruturas de dados.**
...
- **Imagens:**
  <div class="project-images-container">
    <div class="portfolio-images">
      <img src="assets/estrtutura.png" alt="Data Structures" /> </div>
  </div>

---

### 📊 Análise de Grafos
**Exploração de algoritmos clássicos em grafos: BFS, DFS e Dijkstra.**
...
- **Imagens:**
  <div class="project-images-container">
    <div class="portfolio-images">
      <img src="assets/graph.png" alt="Graph Analysis" /> </div>
  </div>
</section>

---

<section id="-competências-técnicas">
...
<section id="-mapa-de-data-science">
## 🗺️ Mapa de Data Science

<details>
  <summary>Clique para expandir o Mapa de Data Science</summary>

  <div align="center">
    <img src="assets/specialties.png" alt="Mapa de Data Science" width="500" /> </div>
</details>
</section>

---

<section id="-diferenciais-competitivos">
## 💡 Diferenciais Competitivos

* **Visão de Negócio:** Habilidade de traduzir problemas complexos em soluções técnicas viáveis e escaláveis.
* **Aprendizado Contínuo:** Atualização constante em IA e ML, com participação em bootcamp internacional DataH.
* **Comunicação Eficaz:** Capacidade comprovada de apresentar insights técnicos de forma clara para stakeholders.
* **Foco em Performance:** Otimização contínua de código e algoritmos para máxima eficiência computacional.
</section>
